...
export const MorseSentenceAtom = atomWithReset<string>(MORSE_SENTENCES[getRandomIndex(MORSE_SENTENCES.length)])

export const LatinSentenceAtom = atomWithReset<string>(LATIN_SENTENCES[getRandomIndex(LATIN_SENTENCES.length)])
